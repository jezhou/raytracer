...
raytracer: point.o camera.o main.o sampler.o scene.o film.o camera.o
	$(CC) $(CFLAGS) -o raytracer point.o camera.o scene.o sampler.o film.o main.o ${INCFLAGS} ${LDFLAGS}
